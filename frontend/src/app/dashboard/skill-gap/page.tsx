...
const careerSkillsMapping: Record<string, SkillItem[]> = {
  ...
  "Prompt Engineer": [
    { subject: "System Prompt Design", current: 40, required: 95, fullMark: 100 },
    { subject: "LLM Architecture", current: 30, required: 85, fullMark: 100 },
    { subject: "Few-Shot & CoT", current: 25, required: 90, fullMark: 100 },
    { subject: "Python / APIs", current: 60, required: 80, fullMark: 100 },
    { subject: "Evaluation & Benchmarking", current: 15, required: 85, fullMark: 100 },
    { subject: "AI Safety & Alignment", current: 20, required: 80, fullMark: 100 },
  ],
  "Cloud Computing Architect": [
    { subject: "AWS / Azure / GCP", current: 45, required: 95, fullMark: 100 },
    { subject: "Infrastructure as Code", current: 30, required: 90, fullMark: 100 },
    { subject: "Kubernetes & Docker", current: 35, required: 85, fullMark: 100 },
    { subject: "Cloud Security", current: 25, required: 90, fullMark: 100 },
    { subject: "Networking & VPCs", current: 40, required: 85, fullMark: 100 },
    { subject: "Cost Optimization", current: 20, required: 80, fullMark: 100 },
  ],
  "AI Engineer": [
    { subject: "Python & PyTorch", current: 65, required: 95, fullMark: 100 },
    { subject: "LangChain / LlamaIndex", current: 30, required: 90, fullMark: 100 },
    { subject: "Vector DBs & RAG", current: 25, required: 90, fullMark: 100 },
    { subject: "Model Fine-Tuning", current: 15, required: 85, fullMark: 100 },
    { subject: "API Integration", current: 70, required: 90, fullMark: 100 },
    { subject: "ML Deployment", current: 35, required: 80, fullMark: 100 },
  ],
  "LLM Engineer": [
    { subject: "Transformer Architectures", current: 30, required: 95, fullMark: 100 },
    { subject: "LoRA & PEFT Fine-Tuning", current: 15, required: 90, fullMark: 100 },
    { subject: "Quantization & ONNX", current: 10, required: 85, fullMark: 100 },
    { subject: "RAG & Knowledge Bases", current: 40, required: 95, fullMark: 100 },
    { subject: "GPU Optimization (CUDA)", current: 10, required: 80, fullMark: 100 },
    { subject: "Agentic Workflows", current: 25, required: 90, fullMark: 100 },
  ],
  "DevOps & MLOps Engineer": [
    { subject: "CI/CD Pipelines", current: 50, required: 95, fullMark: 100 },
    { subject: "Docker & Kubernetes", current: 40, required: 90, fullMark: 100 },
    { subject: "MLflow / Kubeflow", current: 20, required: 85, fullMark: 100 },
    { subject: "Infrastructure (Terraform)", current: 30, required: 85, fullMark: 100 },
    { subject: "Monitoring & Logging", current: 45, required: 85, fullMark: 100 },
    { subject: "Model Drift Tracking", current: 15, required: 80, fullMark: 100 },
  ],
  "Blockchain & Web3 Developer": [
    { subject: "Solidity & Smart Contracts", current: 20, required: 95, fullMark: 100 },
    { subject: "EVM & Ethereum", current: 30, required: 90, fullMark: 100 },
    { subject: "Ethers.js / Web3.js", current: 40, required: 85, fullMark: 100 },
    { subject: "DeFi Protocols", current: 15, required: 80, fullMark: 100 },
    { subject: "Security Auditing", current: 10, required: 85, fullMark: 100 },
    { subject: "Distributed Systems", current: 35, required: 80, fullMark: 100 },
  ],
